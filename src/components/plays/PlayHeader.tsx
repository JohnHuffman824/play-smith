    ...
    <div className="px-8 pt-6 pb-4">
      <div className="flex gap-4 items-center">
        <input
          ...
          className={`flex-1 px-4 py-3 rounded-xl border shadow-sm focus:shadow-md hover:shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all ${
            theme === 'dark'
